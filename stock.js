function getStocks(){
    ...
    .then((data) => {
        data.map((api1) => {
            ...
            .then((api2) => {
                var element = `
                    <div class="card" style="width:25%;height:450px;float:left;margin-left:6%;margin-top:2%; background-color: #bcaeae">
                        <img src='${api1.logo}' class="card-img-top" style="height:250px; border-radius: 3%;"/>
                        <div class="card-body">
